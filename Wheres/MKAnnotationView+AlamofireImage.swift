//
//  MKAnnotationView+AlamofireImage.swift
//  Wheres
//
...
extension MKAnnotationView {
    ...
    public enum ImageTransition {
        ...
        case custom(
            ...
            animations: (MKAnnotationView, Image) -> Void,
        ...
        /// The animation options of the image transition.
        public var animations: ((MKAnnotationView, Image) -> Void) {
            switch self {
    ...
    private struct AssociatedKey {
        static var imageDownloader = "af_MKAnnotationView.ImageDownloader"
        static var sharedImageDownloader = "af_MKAnnotationView.SharedImageDownloader"
        static var activeRequestReceipt = "af_MKAnnotationView.ActiveRequestReceipt"
    }
    
    // MARK: - Associated Properties
    
    /// The instance image downloader used to download all images. If this property is `nil`, the `MKAnnotationView` will
        ...
        completion: ((DataResponse<UIImage>) -> Void)? = nil)
    {
        ...
        let imageDownloader = af_imageDownloader ?? MKAnnotationView.af_sharedImageDownloader
